...
const models: TsoaRoute.Models = {
    "IFile": {
        "dataType": "refObject",
        "properties": {
            "fileHash": {"dataType":"string","required":true},
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/image/upload',
            ...
            function ImageController_uploadFile(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/image/merge',
            ...
            function ImageController_mergeFileChunk(request: any, response: any, next: any) {
            const args = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"IFile"},
            };
            ...
            try {
              ...
              const promise = controller.mergeFileChunk.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/pdf/uploadFile',
            upload.single('file'),

            function PdfController_createUser(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/ue/upload',
            ...
            function UEController_uploadFile(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
            ...
            try {
                ...
                const controller = new UEController();
        ...
        app.post('/ue/merge',
            ...
            function UEController_mergeFileChunk(request: any, response: any, next: any) {
            const args = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"IFile"},
            };
